...
export default function BankShieldApp() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans antialiased selection:bg-emerald-500 selection:text-white flex flex-col justify-between">
      <div>
        ...
        {pageStage === 'portal' && (
          <div className="w-full px-4 sm:px-6 lg:px-8 py-4">
            ...
            {/* SUB-TAB 4: UNIFIED LIGHT AUDIT HISTORY */}
            {portalSubTab === 'audit' && (
              <main className="w-full space-y-6 animate-in fade-in duration-300">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-6">
                    ...
                    <div className="flex items-center gap-2 shrink-0 flex-wrap">
                      <button
                        ...
                        className="px-3.5 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs transition border border-slate-800 shadow-sm flex items-center gap-1.5 cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="px-3.5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs transition shadow-sm flex items-center gap-1.5 cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-900 rounded-xl text-xs font-bold transition flex items-center gap-2 border border-slate-200 cursor-pointer"
                      >
                        <span>📄</span>
                    ...
                    <table className="w-full text-left text-xs">
                      ...
                      <tbody className="divide-y divide-slate-200 bg-white font-medium">
                        {filteredAuditLogs.map((log, idx) => (
                          <tr key={idx} className="even:bg-slate-50/50 hover:bg-slate-50 transition">
                            ...
                            <td className="py-4 px-4">
                              ...
                              <span className="block text-[10px] text-slate-500 font-mono">{log.vpa}</span>
                            </td>
                            ...
                            <td className="py-4 px-4">
                              <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-black ${
                                ...
                                {log.status === 'Aborted & Frozen' && <Ban className="w-3 h-3 text-rose-700" />}
                                {(log.status === 'Completed' || log.status === 'Guardian Cleared' || log.status === 'Credit Cleared') && <Check className="w-3 h-3 text-emerald-700" />}
                                {log.status}
                              </span>
                            </td>
